...
โฟลเดอร์นี้รวบรวมไฟล์สไลด์ PDF ทั้งหมด 10 ชุดของเทอม 2568 (New Curriculum) โดยจัดเรียงลำดับเนื้อหาตามสัปดาห์และบทเรียน เพื่อให้อ่านเข้าใจง่ายและต่อเนื่อง
...
[04 - 05] วิศวกรรมความต้องการ (Requirements Elicitation & Specification)
       ↓
[06 - 07] ระเบียบวิธีแบบ Agile & Scrum Framework และ Burndown Chart
       ↓
[08 - 10] การทดสอบซอฟต์แวร์ (Ch6 Software Testing, Testing QA, White-Box & Cyclomatic Complexity)
```

---

## 📑 รายละเอียดเนื้อหาแต่ละไฟล์ (10 ไฟล์หลักเทอม 68)
...
| **06** | `06_Agile_and_Scrum_Framework.pdf` | **Agile & Scrum** | Agile Manifesto 12 ประการ, บทบาทใน Scrum (PO, SM, Dev), พิธีกรรม (Sprint, Daily, Review, Retro), User Stories |
| **07** | `07_Scrum_Burndown_Chart.pdf` | **Burndown Chart** | การวิเคราะห์กราฟ Burndown Chart, Ideal Line vs Actual Effort, ปัญหา Scope Creep และการวัด Team Velocity |
| **08** | `08_Ch6_Software_Testing.pdf` | **สไลด์บทที่ 6: Testing (ฉบับเต็ม)** | ภาพรวมการทดสอบซอฟต์แวร์ของอาจารย์ (Verification & Validation, Test Case Design, Testing Strategies) |
| **09** | `09_Week9_Software_Testing_and_QA.pdf` | **การทดสอบซอฟต์แวร์ (Week 9)** | ระดับการทดสอบ (Unit, Integration, System, Acceptance), TDD, Black-Box (Equivalence Partitioning, BVA) |
| **10** | `10_Week10_Testing_Metrics_Cyclomatic.pdf` | **การวัดผลเชิงโครงสร้าง (Week 10)** | White-Box Testing, Flow Graph, Basis Path Testing, สูตร Cyclomatic Complexity $V(G) = E - N + 2$ |
...
- สำหรับการเตรียมสอบกลางภาค (Midterm): ควรอ่านลำดับที่ **01 ถึง 07** ร่วมกับสไลด์ Use Case ในหมวด Old
- สำหรับการเตรียมสอบปลายภาค (Final): เน้นลำดับที่ **08 ถึง 10** ซึ่งครอบคลุมบท Testing ทั้งหมด
