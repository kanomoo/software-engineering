...
* **เงื่อนไขสำคัญ (Business Rules / Constraints):**
  1. *ก่อนยืมหนังสือ:* ระบบต้อง **ตรวจสอบสิทธิ์การยืมของนักศึกษา** เสมอ (เช่น สมาชิกภาพยังไม่หมดอายุ, ไม่มียอดค้างชำระค่าปรับเกินกำหนด, จำนวนหนังสือที่ยืมยังไม่เกินโควตา)
  2. *ก่อนยืมหนังสือ:* ระบบต้อง **ตรวจสอบว่าหนังสือยังว่างอยู่หรือไม่** เสมอ (สถานะหนังสือต้องเป็น Available ไม่ถูกยืมไปโดยผู้อื่น หรือถูกสำรองไว้)
* **เป้าหมายการวิเคราะห์:**
  * หา Actor ของระบบ
  * หา Use Case จากความต้องการ
  * หา Relationship ที่เหมาะสม (`<<include>>`)
  * สรุปเป็น Use Case Diagram ตามมาตรฐาน UML
...
> [!info] 💡 ใครคือ Actor ในระบบห้องสมุด?
> **Actor คือผู้ที่มีปฏิสัมพันธ์กับระบบจากภายนอก (Outside System Boundary)** ไม่ใช่บุคคลคนเดียว แต่หมายถึง **"บทบาท (Role)"** ที่มีต่อระบบ

### 2.1 รายชื่อ Actors และเหตุผลที่เลือก
| Actor | บทบาท (Role) | เหตุผลที่เลือกเป็น Actor | เป้าหมายหลักต่อระบบ (Main Goal) |
|:---|:---|:---|:---|
| **Student** | นักศึกษา / สมาชิกผู้ใช้บริการ | เป็นผู้ใช้ภายนอกที่เข้ามาสืบค้นและทำรายการยืมทรัพยากร | ค้นหาหนังสือ และยืมหนังสือกลับไปศึกษา |
| **Librarian** | เจ้าหน้าที่ห้องสมุด / บรรณารักษ์ | เป็นเจ้าหน้าที่ฝ่ายปฏิบัติการที่รับคืนและดูแลคลังหนังสือ | บันทึกการคืนหนังสือ และจัดการฐานข้อมูลหนังสือ |

*สรุปผลการวิเคราะห์:* ในขอบเขตเริ่มต้น ระบบมี **2 Actors** หลัก คือ **`Student`** และ **`Librarian`**
...
แปลงความต้องการของ Actor แต่ละกลุ่มให้เป็นบริการหรือพฤติกรรมที่ระบบต้องจัดเตรียมไว้ให้:
